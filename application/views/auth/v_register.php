              ...
              <div class="card-body">
                <form method="POST" action="<?= base_url('auth/register'); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="pekerjaan" type="text" class="form-control" name="pekerjaan" autofocus value="<?= set_value('pekerjaan'); ?>">
                    <small class="text-danger "><?= form_error('pekerjaan') ?></small>
                  </div>

                  <div class="form-group">
                    <label for="instansi">Instansi</label>
                    <input id="instansi" type="text" class="form-control" name="instansi" autofocus value="<?= set_value('instansi'); ?>">
                    <small class="text-danger "><?= form_error('instansi') ?></small>
                  </div>

                  <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <input id="alamat" type="text" class="form-control" name="alamat" autofocus value="<?= set_value('alamat'); ?>">
