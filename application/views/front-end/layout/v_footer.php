    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info card shadow-none">
          ...
          <p>REE TECH is a company focused on developing AI, Web 3 and IoT solutions for various industrial sectors founded in early 2020.</p>
          <!--<p><?= $setting->profile; ?></p>-->
        ...
        <div class="col-lg-2 col-6 footer-links">
          ...
          <!--  <li>Machine Learning Model</li>-->
            <!--  <li><i class="bi bi-chevron-right"></i> <a href="#"><?= $value->nama_layanan; ?></a></li>-->
            <!--?php endforeach; ?>-->
          <!--</ul>-->
        </div>
