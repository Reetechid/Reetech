  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">
        Di halaman ini Anda dapat membuat Client baru
      </p>
              ...
              <form method="POST" action="<?= base_url('client/tambahclient'); ?>" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="form-group col-lg-6 col-sm-12 col-md-12">
                    ...
                    <input type="text" class="form-control" name="website" autofocus value="<?= set_value('website'); ?>" placeholder="Url Website">
